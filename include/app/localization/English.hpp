...
inline constexpr char kExitApp = 'q';
inline constexpr char kLanguageShortcut = 'l';
inline constexpr const char* kStartButton = "Start [S]";
inline constexpr const char* kLanguageButton = "Language [L]";
...
inline constexpr const char* kBackEscape = "Exit [ESC]";
...
inline constexpr char kUndoShortcut = 'b';
inline constexpr char kResetAllShortcut = 'r';
inline constexpr char kRateNewShortcut = '1';
inline constexpr char kRateKnownShortcut = '2';
inline constexpr char kRateMasteredShortcut = '3';
inline constexpr char kEditShortcut = 'e';
inline constexpr char kDeleteShortcut = 'd';
inline constexpr char kCopyShortcut = 'c';
...
inline constexpr const char* kRateNewButton = "NEW [← | ALT+1]";
inline constexpr const char* kRateKnownButton = "KNOWN [↓ | ALT+2]";
inline constexpr const char* kRateMasteredButton = "MASTERED [→ | ALT+3]";
inline constexpr const char* kAnswerPlaceholder = "Type your answer...";
inline constexpr const char* kHintFlipButton = "[↑ / ENTER] Check answer and flip";
...
inline constexpr char kEditShortcut = 'e';
inline constexpr char kDeleteShortcut = 'u';
inline constexpr char kCopyShortcut = 'k';
inline constexpr char kMoveShortcut = 'p';
inline constexpr char kImportShortcut = 'i';
inline constexpr const char* kEditTitle = "Edit Card";
...
inline constexpr char kNewFolderShortcut = 'f';
inline constexpr char kNewListShortcut = 'n';
inline constexpr char kRenameShortcut = 'r';
inline constexpr char kDeleteShortcut = 'u';
...
inline constexpr const char* kDeleteToolbarButton = "Delete [U]";
inline constexpr const char* kLanguageButton = common::kLanguageButton;
