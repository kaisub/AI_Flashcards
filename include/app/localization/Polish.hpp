...
inline constexpr const char* kLanguageButton = "Język [L]";
...
inline constexpr const char* kBackEscape = "Wyjdź [ESC]";
...
inline constexpr const char* kHintResetAllButton = "[ALT+R] Resetuj wszystko";
